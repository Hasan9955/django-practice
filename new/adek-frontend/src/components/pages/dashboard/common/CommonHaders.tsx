...
import welcomeimg from "@/assets/icons/dashborad/fi_9971673.png";
...
const CommonHaders = () => {
	...
	return (
		<div className="block w-full px-2 pt-4 pb-4 ">
			<div className="flex justify-between items-center">
				<div className="flex items-center text-[32px] gap-2">
					{pathname === "dashboard/sellapypro" ? (
						<h4 className="font-nun font-medium text-[#1C1C1C]">
							Sellapy pro plans
						</h4>
					) : (
						<h4 className="font-nun font-medium text-[#1C1C1C]">

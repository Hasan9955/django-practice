      ...
      try {
        ...
        switch (parsedData.type) {
          ...
          case MessageTypes.SEND_GROUP_MESSAGE:
            ...
            break;
          case MessageTypes.JOIN_TICKET_CHAT:
            await handleJoinTicketChat(ws, parsedData, chatRooms);
            break;
          case MessageTypes.SEND_TICKET_MESSAGE:
            await handleSendTicketMessage(ws, parsedData);
            break;
          case MessageTypes.JOIN_REFUND_CHAT:
            await handleJoinRefundChat(ws, parsedData, chatRooms);
            break;
          case MessageTypes.SEND_REFUND_MESSAGE:
            await handleSendRefundMessage(ws, parsedData);
            break;

...
const productImage = upload.array("productImage");
...
const uploadPlatformImage = upload.fields([
  { name: "logo", maxCount: 1 },
  { name: "banner", maxCount: 100 },
  { name: "crmBanner", maxCount: 100 },
  {
    name: "categoryImage",
    maxCount: 100,
  },
...
const categoryImage = upload.single("categoryImage");
